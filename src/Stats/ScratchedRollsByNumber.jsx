...
import { getScratchedRollsByFrequency } from './StatsHelper'
...
class ScratchedRollsByNumber extends Component {
  render() {
    ...
    return (
      <div>
        <Paper>
          <Chart
            data={getScratchedRollsByFrequency(history)}
          >
...
export default connect(mapStateToProps)(ScratchedRollsByNumber)